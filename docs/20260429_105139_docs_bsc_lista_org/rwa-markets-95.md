---
source: https://docs.bsc.lista.org/introduction/rwa-markets
crawled_at: 2026-04-29T10:51:39.155815
---
...
### [hashtag](https://docs.bsc.lista.org/introduction/rwa-markets\#how-it-works)    How it works
...
### [hashtag](https://docs.bsc.lista.org/introduction/rwa-markets\#dowsure-rwa-token)    Dowsure RWA Token

#### [hashtag](https://docs.bsc.lista.org/introduction/rwa-markets\#product-details)    Product Details
...
Historic Bad Debt Rate

< 1.5% (5-year average)

Auto-Roll

Yes (opt-out by Day 83)
...
### [hashtag](https://docs.bsc.lista.org/introduction/rwa-markets\#security-and-risk-controls)    Security & Risk Controls
...
[PreviousSmart Lending & Swapchevron-left](https://docs.bsc.lista.org/introduction/smart-lending) [NextLista Creditchevron-right](https://docs.bsc.lista.org/introduction/lista-credit)
