---
source: https://docs.bsc.lista.org/introduction/lista-lending/vaults
crawled_at: 2026-04-29T10:51:39.156203
---
...
As a permissionless lending protocol, Lista also allows third-party vault creation and curation. Lista DAO does not review, audit, certify, or endorse third-party vaults or their respective Curators. Please read our [third-party vault risk disclosure](https://docs.bsc.lista.org/introduction/lista-lending/third-party-vault-risk-management) and employ robust risk mitigation methods before depositing into third-party curated vaults.

## [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/vaults\#vaults-and-markets)    Vaults and Markets
...
## [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/vaults\#core-players-and-components)    Core Players & Components

### [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/vaults\#id-1.-oracles)    1\. Oracles
...
### [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/vaults\#id-2.-vault-owner)    2\. Vault Owner

At Lista, vault owners can decide which markets to invest funds in. By default, the depositor delegates risk management to the Vault Owner, who has full control. Vault owners will be solely responsible for what happens to the assets deposited into the vault. Refer to our [risk disclosure](https://docs.bsc.lista.org/introduction/lista-lending/third-party-vault-risk-management) for more information.

### [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/vaults\#id-3.-customize-bad-debt-handling)    3\. Customize Bad Debt Handling

Bad debts can be either amortized (spread out, gradually being reduced over time) or handled manually.

### [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/vaults\#id-4.-account-management)    4\. Account Management

Operates via traditional function calls, or message signatures based on the [EIP-712arrow-up-right](https://eips.ethereum.org/EIPS/eip-712) standard.

### [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/vaults\#id-5.-time-locks)    5\. Time locks

Vault Owners can optionally set timelocks to govern critical parameter changes and risk management processes.

### [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/vaults\#id-6.-vault-fees)    6\. Vault Fees
...
### [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/vaults\#id-7.-assignors)    7\. Assignors
...
[PreviousLista Lendingchevron-left](https://docs.bsc.lista.org/introduction/lista-lending) [NextLista Alpha Zonechevron-right](https://docs.bsc.lista.org/introduction/lista-lending/vaults/lista-alpha-zone)
