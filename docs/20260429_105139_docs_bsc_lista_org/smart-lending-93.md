---
source: https://docs.bsc.lista.org/introduction/smart-lending
crawled_at: 2026-04-29T10:51:39.154394
---

## [hashtag](https://docs.bsc.lista.org/introduction/smart-lending\#smart-lending)    Smart Lending
...
### [hashtag](https://docs.bsc.lista.org/introduction/smart-lending\#how-it-works)    How It Works

#### [hashtag](https://docs.bsc.lista.org/introduction/smart-lending\#deposit-and-borrow)    Deposit & Borrow
...
#### [hashtag](https://docs.bsc.lista.org/introduction/smart-lending\#repay-and-withdraw)    Repay & Withdraw
...
#### [hashtag](https://docs.bsc.lista.org/introduction/smart-lending\#liquidation)    Liquidation
...
Please refer to our [liquidation documentationarrow-up-right](https://docs.bsc.lista.org/introduction/lista-lending/liquidation) and [this articlearrow-up-right](https://blog.lista.org/everything-you-need-to-know-about-liquidation-on-lista-smart-lending) for more details.

## [hashtag](https://docs.bsc.lista.org/introduction/smart-lending\#smart-swap)    Smart Swap
...
![](https://docs.bsc.lista.org/~gitbook/image?url=https%3A%2F%2F1802824789-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F60fXF9rALi6luWHVkkGg%252Fuploads%252FkG7oBdtUQFJLkLCh2of7%252FSwap.png%3Falt%3Dmedia%26token%3D5e43ecaa-85d5-4326-b641-f35312647540&width=768&dpr=3&quality=100&sign=6f4eb5a7&sv=2)
...
[PreviousTechnical Guidechevron-left](https://docs.bsc.lista.org/introduction/liquid-staking-slisbnb/technical-guide) [NextRWA Marketschevron-right](https://docs.bsc.lista.org/introduction/rwa-markets)
