---
source: https://docs.bsc.lista.org/introduction/lista-lending/liquidation
crawled_at: 2026-04-29T10:51:39.135350
---
...
### [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/liquidation\#understanding-loan-to-value-ltv-ratio)    Understanding Loan-To-Value (LTV) Ratio
...
Oracle Price Scale is 103610^{36}1036 and is used for price normalization.

Example:

At Lista's BNB/USDT market, if you deposit 1 BNB and borrow out 500 USDT.

At a certain time, the price of BNB/USDT Lista fetches from the oracles is 8×10388\\times10^{38}8×1038. Divide this number by 103610^{36}1036, we will get the normalized price of BNB: 800 USDT.

Then the LTV of this loan is 500800×100%=62.5%\\frac{500}{800}\\times 100\\% = 62.5\\%800500​×100%=62.5%

### [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/liquidation\#standard-liquidation)    Standard Liquidation
...
#### [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/liquidation\#when-is-a-position-liquidatable)    **When Is a Position Liquidatable?**
...
#### [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/liquidation\#how-liquidation-works)    **How Liquidation Works**
...
- β\\betaβ is a constant, 0.3.

- MMM is the maximum incentive factor, 1.15.
...
#### [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/liquidation\#a-step-by-step-example)    **A Step-by-Step Example**

Let's say you deposited 100 USDT and borrowed out 91.5 USD1. This market has an LLTV of 91.5%.

Your LTV is 91.5/100=91.5%91.5/100 = 91.5\\%91.5/100=91.5%, so the moment interest starts accruing, your LTV will exceed the LLTV. A liquidation will be triggered and a liquidator will step in to repay the debt. (This is also why we do not recommend borrowing close to LLTV)
...
This is smaller than the minimum LIF, 1.048 so LIF=1.048LIF=1.048LIF=1.048.
...
If the loan is repaid in full, which means the liquidator pays 91.5 USD1 plus a minuscule amount of interest, they will then receive slightly more than 95.892 USDT. Their profit is: 95.892USDT−91.5USD1≈$4.392 minus gas fees.

### [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/liquidation\#delayed-liquidation)    Delayed Liquidation

Following the approval of [LIP-024arrow-up-right](https://snapshot.org/#/s:listavote.eth/proposal/0x1a15347f6b452049212bdf51ff1a46c0a7edf7ca8efe1004b32c15c2965f0f3b), delayed liquidation is launched for selected markets as the first benefit for LISTA holders.
...
### [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/liquidation\#smart-lending-liquidation)    Smart Lending Liquidation

Liquidation at Smart Lending works similarly but the value of collateral is calculated slightly differently. Refer to [this articlearrow-up-right](https://blog.lista.org/everything-you-need-to-know-about-liquidation-on-lista-smart-lending) for more details.

[PreviousFeeschevron-left](https://docs.bsc.lista.org/introduction/lista-lending/fees) [NextLiquidation Zonechevron-right](https://docs.bsc.lista.org/introduction/lista-lending/liquidation/liquidation-zone)
