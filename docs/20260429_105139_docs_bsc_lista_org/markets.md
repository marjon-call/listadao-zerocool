---
source: https://docs.bsc.lista.org/zh-cn/jian-jie/lista-lending/markets
crawled_at: 2026-04-29T10:51:39.125579
---

市场是一个独立的借贷池，将一个抵押资产与一个贷款资产配对（例如：slisBNB/BNB）。每个市场独立运作，隔离风险以防止溢出，并在启动后保持不变。每个金库中的资产可以与多个市场配对。创建市场是无需许可的。

#### [hashtag](https://docs.bsc.lista.org/zh-cn/jian-jie/lista-lending/markets\#wu-xu-xu-ke-de-shi-chang-chuang-jian)    无需许可的市场创建
...
#### [hashtag](https://docs.bsc.lista.org/zh-cn/jian-jie/lista-lending/markets\#shi-chang-chuang-jian-ji-zhi)    市场创建机制
...
[PreviousLoop BNB 金库chevron-left](https://docs.bsc.lista.org/zh-cn/jian-jie/lista-lending/vaults/loop-bnb-vault) [Next借款人与供应商chevron-right](https://docs.bsc.lista.org/zh-cn/jian-jie/lista-lending/borrowers-and-suppliers)
