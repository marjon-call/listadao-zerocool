---
source: https://docs.bsc.lista.org/introduction/collateral-debt-position-lisusd/collateral
crawled_at: 2026-04-29T10:51:39.144258
---
...
### [hashtag](https://docs.bsc.lista.org/introduction/collateral-debt-position-lisusd/collateral\#liquid-staking-tokens-lsts)    Liquid staking Tokens (LSTs)
...
### [hashtag](https://docs.bsc.lista.org/introduction/collateral-debt-position-lisusd/collateral\#liquid-restaking-tokens-lrts)    Liquid restaking tokens (LRTs)
...
[PreviousCollateral Debt Position - lisUSDchevron-left](https://docs.bsc.lista.org/introduction/collateral-debt-position-lisusd) [NextClassic collateral optionschevron-right](https://docs.bsc.lista.org/introduction/collateral-debt-position-lisusd/collateral/classic-collateral-options)
