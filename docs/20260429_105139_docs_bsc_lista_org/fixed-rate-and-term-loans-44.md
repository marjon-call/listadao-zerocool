---
source: https://docs.bsc.lista.org/introduction/lista-lending/fixed-rate-and-term-loans
crawled_at: 2026-04-29T10:51:39.132865
---

There are 2 interest rate and term options to choose from when borrowing at Lista: flexible and fixed.

Flexible interest rate works just like other lending products at Lista DAO where borrowers can borrow and repay their loans any time and the interest rate fluctuates depending on the utilization rate, as dictated by our [Interest Rate Modelarrow-up-right](https://docs.bsc.lista.org/introduction/lista-lending/interest-rate-model-irm).
...
[PreviousInterest Rate Model (IRM)chevron-left](https://docs.bsc.lista.org/introduction/lista-lending/interest-rate-model-irm) [NextFeeschevron-right](https://docs.bsc.lista.org/introduction/lista-lending/fees)
