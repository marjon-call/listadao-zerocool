---
source: https://docs.bsc.lista.org/introduction/lista-lending/third-party-vault-risk-management
crawled_at: 2026-04-29T10:51:39.138418
---
...
The appearance or display of any vault on [lista.orgarrow-up-right](http://lista.org/) within the UI is for informational purposes only and does not constitute a recommendation, review, or endorsement by Lista DAO.

#### [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/third-party-vault-risk-management\#vault-deployment-and-independence)    **Vault Deployment and Independence**
...
#### [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/third-party-vault-risk-management\#risk-parameter-management)    **Risk Parameter Management**
...
#### [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/third-party-vault-risk-management\#oracle-and-pricing-mechanisms)    **Oracle and Pricing Mechanisms**
...
#### [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/third-party-vault-risk-management\#supply-and-borrow-caps)    **Supply and Borrow Caps**
...
#### [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/third-party-vault-risk-management\#advanced-risk-control)    **Advanced Risk Control**
...
#### [hashtag](https://docs.bsc.lista.org/introduction/lista-lending/third-party-vault-risk-management\#important-safety-notice)    **Important Safety Notice**
...
[PreviousUser Flowchevron-left](https://docs.bsc.lista.org/introduction/lista-lending/user-flow) [NextBinance Launchpool: slisBNBxchevron-right](https://docs.bsc.lista.org/introduction/binance-launchpool-clisbnb)
